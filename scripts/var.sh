...
# Path configuration
CHECKPOINT_DIR="${PROJECT_DIR}/checkpoints/released_${MODEL_TYPE}-Multi-scale-Cluster-Memory"
LOG_DIR="${PROJECT_DIR}/logs/released_${MODEL_TYPE}-Multi-scale-Cluster-Memory"
CACHE_DIR="${PROJECT_DIR}/cache/Multi-scale-Cluster-Memory"
