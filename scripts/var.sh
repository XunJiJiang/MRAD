...
# Path configuration
CHECKPOINT_DIR="${PROJECT_DIR}/checkpoints/released_${MODEL_TYPE}-Graph-Memory"
LOG_DIR="${PROJECT_DIR}/logs/released_${MODEL_TYPE}-Graph-Memory"
CACHE_DIR="${PROJECT_DIR}/cache/Graph-Memory"
